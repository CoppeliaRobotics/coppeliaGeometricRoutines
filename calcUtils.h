...
public:
    ...
    static bool getDistance_tris_segp(const C3Vector& p,const C3Vector& v,const C3Vector& w,const C3Vector& segP,const C3Vector& segL,float& dist,C3Vector* minDistSegPt1,C3Vector* minDistSegPt2);
    static bool getDistance_tris_pt(const C3Vector& p,const C3Vector& v,const C3Vector& w,const C3Vector& pt,float& dist,C3Vector* minDistSegPt);
    static bool getDistance_seg_seg(const C3Vector& seg1Center,const C3Vector& seg1Hs,const C3Vector& seg2Center,const C3Vector& seg2Hs,float& dist,C3Vector* minDistSegPt1,C3Vector* minDistSegPt2);
    static bool getDistance_segp_segp(const C3Vector& seg1P,const C3Vector& seg1L,const C3Vector& seg2P,const C3Vector& seg2L,float& dist,C3Vector* minDistSegPt1,C3Vector* minDistSegPt2);
    static bool getDistance_segp_pt(const C3Vector& segP,const C3Vector& segL,const C3Vector& pt,float& dist,C3Vector* minDistSegPt);
    ...
    static bool isApproxDistanceSmaller_box_box_fast(const C4X4Matrix& box1,const C3Vector& box1Hs,const C4X4Matrix& box2,const C3Vector& box2Hs,float& dist);
    static bool isApproxDistanceSmaller_box_cell(const C4X4Matrix& box,const C3Vector& boxHs,float cellHs,float& dist);
    static bool isApproxDistanceSmaller_box_cell_fast(const C4X4Matrix& box,const C3Vector& boxHs,float cellHs,float& dist);
    ...
    static bool isApproxDistanceSmaller_box_tri_fast(const C4X4Matrix& box,const C3Vector& boxHs,const C3Vector& p,const C3Vector& v,const C3Vector& w,float& dist);
    ...
    static bool isApproxDistanceSmaller_box_seg_fast(const C4X4Matrix& box,const C3Vector& boxHs,const C3Vector& segCenter,const C3Vector& segHs,float& dist);
    ...
    static bool isApproxDistanceSmaller_box_segp_fast(const C4X4Matrix& box,const C3Vector& boxHs,const C3Vector& segP,const C3Vector& segL,float& dist);
    static bool isApproxDistanceSmaller_box_pt_fast(const C4X4Matrix& box,const C3Vector& boxHs,const C3Vector& pt,float& dist);
    static bool isApproxDistanceSmaller_cell_tri(float cellHs,const C3Vector& p,const C3Vector& v,const C3Vector& w,float& dist);
    static bool isApproxDistanceSmaller_cell_tri_fast(float cellHs,const C3Vector& p,const C3Vector& v,const C3Vector& w,float& dist);
    static bool isApproxDistanceSmaller_cell_seg(float cellHs,const C3Vector& segCenter,const C3Vector& segHs,float& dist);
    static bool isApproxDistanceSmaller_cell_seg_fast(float cellHs,const C3Vector& segCenter,const C3Vector& segHs,float& dist);
    static bool isApproxDistanceSmaller_cell_segp(float cellHs,const C3Vector& segP,const C3Vector& segL,float& dist);
    static bool isApproxDistanceSmaller_cell_segp_fast(float cellHs,const C3Vector& segP,const C3Vector& segL,float& dist);
    ...
    static bool isApproxDistanceSmaller_tri_tri_fast(const C3Vector& p1,const C3Vector& v1,const C3Vector& w1,const C3Vector& p2,const C3Vector& v2,const C3Vector& w2,float& dist);
    ...
    static bool isApproxDistanceSmaller_segp_segp_fast(const C3Vector& seg1P,C3Vector seg1L,const C3Vector& seg2P,C3Vector seg2L,float& dist);
